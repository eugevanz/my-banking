...
export default function Model({ ...props }) {
  ...
  useFrame(({ camera }) => {
    active ? vec.set(3, 3, 5.9) : vec.set(0, 0, 9.3);
    camera.fov = 50;
    camera.lookAt(0, 0, 0);
  ...
  return (
    <group ref={group} onClick={() => setActive(!active)} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group scale={0.01}>
            ...
            <mesh
              geometry={
                nodes.final_Diorama_combined_canoe2canoe_tire_pulley_0.geometry
              }
            ...
            <mesh
              geometry={
                nodes.final_Diorama_combined_lighthouselighthouse_MAT_0.geometry
              }
            ...
            />
            <mesh
              geometry={nodes.final_Diorama_combined_lighthouseglass_0.geometry}
            ...
            <mesh
              geometry={
                nodes.final_Diorama_combined_trees2Fern_YellowLeaves1_0.geometry
              }
